      ...
      <section className="method-section" aria-labelledby="method-title">
        <div className="method-stamp"><span>AV</span><small>2024</small></div>
          <div>
            ...
            <p className="method-copy">This atlas follows the confirmed <i>Catalogue of Sites</i> in Avramova’s dissertation (digital pp. 199–249; printed pp. 195–245). Architecture, spring deposits, water data and citations are preserved as distinct evidence threads. Seven records have cited plans. Four also offer experimental 3D plan reliefs: source-traced horizontal outlines, raised only to aid viewing. Ancient elevations and missing architecture are not reconstructed.</p>
            ...
            {showCaveats && <div className="caveat-box">
              ...
              <p><b>Plans and images:</b> Cited plan material is available for Pautalia, Germania, Ulpia Serdica, Diocletianopolis, Starozagorski Bani, Mineralni Bani (Haskovo) and Aquae Calidae. Plans, archaeological plates and credited place photographs can be enlarged. Reviewed reliefs are available for Pautalia (public thermae, Fig. 50), Diocletianopolis (Momina salza, Fig. 37), Starozagorski Bani (recorded fabric, Fig. 24) and Haskovo (second spring group, Fig. 19). Copper drawing outlines do not assert wall thickness, and all display heights are schematic. Source underlays start on. Other sites are omitted from 3D where identification, geometry or phase separation could not be represented reliably.</p>
